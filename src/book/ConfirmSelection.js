...
function ConfirmSelection({ selectedDate, selectedTime, selectedLength, availableCourts, onConfirm, onCancel }) {
    ...
    <div className="confirm-selection-container">
        ...
        <p><strong>選擇可用場地 (不選擇則隨機)</strong></p>
        ...
        <button className="confirm-button" onClick={() => onConfirm(selectedCourt)}>確認</button>
