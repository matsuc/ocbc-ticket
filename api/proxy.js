...
export default async function handler(req, res) {
  ...
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, cp-book-facility-session-id'); // 指定允許的請求頭部
  ...
  try {
    ...
    const axiosConfig = {
      ...
      headers: {
        ...
        'Cp-Book-Facility-Session-Id': req.headers['cp-book-facility-session-id'] || '',
    },
      httpsAgent,
    };
    ...
    res.setHeader('Access-Control-Expose-Headers', Object.keys(response.headers).join(', '));
